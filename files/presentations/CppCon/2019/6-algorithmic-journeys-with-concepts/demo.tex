...
\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.7.h}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.8.h}
	\end{block}
\end{frame}
...
\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.0.h}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.1.h}
	\end{block}
\end{frame}
...
\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.2.h}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{Dealing with large objects}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.3.h}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.4.h}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.5.cpp}
	\end{block}
\end{frame}

\begin{frame}{Journey \#1}
    \begin{block}{}
		\lstinputlisting[language=c++]{code/journeys/1/0.min.6.h}
	\end{block}
\end{frame}
